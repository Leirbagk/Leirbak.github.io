<!DOCTYPE html>
	...
	<head>
		...
		<body>
					...
					<div class="container">
						  ...
						  <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
						    <ul class="navbar-nav">
								...
								<li><a href="#service">Instrucciones</a></li>
			...
			<!-- start banner Area -->
			<section class="banner-area relative" id="home" data-parallax="scroll" data-image-src="img/a4.jpg">
				...
				<div class="container">
					<div class="row fullscreen  d-flex align-items-center justify-content-end">
						<div class="banner-content col-lg-6 col-md-12">
							<h1>
								Biodiesel  <br>
								<span>A partir de aceites</span>Vegetales utilizando <br>
								 <span>Enzimas libres</span>							
							</h1>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Resumen</h1>
								<p style="text-align: justify;">las principales variables que afectan el
									rendimiento de la reacción de transesterificación de
									aceites vegetales con etanol utilizando enzimas
									(lipasas) libres de Cándida rugosa y Pseudomonas
									fluorescens como catalizador, y se analiza teóricamente
									la viabilidad de adaptar al proceso un sistema
									híbrido reacción-separación que contribuya a mejorar
					...
					<div class="row">
						<div class="sigle-service col-lg-3 col-md-6">
							...
							<p style="text-align: justify;">
								Transesterificación es el nombre con el que se conoce
								al tipo de reacción en la que los triglicéridos (TG)
								presentes en los aceites vegetales y grasas animales
								se combinan con un alcohol (alcohólisis) en presencia
								de un catalizador, para formar una mezcla de ésteres
								grasos (biodiesel), cuyos tamaños y propiedades son
								similares a las del diesel de petróleo y glicerina
								(Encinar, 2002). La reacción global de transesterificación
						...
						<div class="sigle-service col-lg-3 col-md-6">
							...
							<h4>Materiales</h4>
							<p style="text-align: justify;">
								El aceite de palma crudo, aceite de
								higuerilla(se puede adquirir en una farmacia local). Las
								enzimas de Cándida rugosa (lipasa AY) y
								Pseudomonas fluorescens (lipasa AK)
								. El etanol y el NaOH utilizados fueron
								de grado analítico junto con los
								demás reactivos empleados y suministrados por un proveedor local.
							</p>
						...
						<div class="sigle-service col-lg-3 col-md-6">
							...
							<h4>Metodos</h4>
							<p>
								1-Caracterización de los aceites <br>
								2-Transesterificación <br>
								3-Análisis de ésteres <br>
								4-Resultados <br>
								5-Efecto del catalizador <br>
								6-Análisis de la transesterificación <br>	
								7.Conclusiones
							</p>
						<!--	<a href="#" class="text-uppercase primary-btn2 primary-border circle">Ver detalles</a>-->
						</div>
						<div class="sigle-service col-lg-3 col-md-6">
							...
							<h4>Referencias</h4>
							<p>
								En esta seccion hacemos referencias a todos los antecedentes utilizados para este tipo de preparacion de biodiesel.
							</p>
							<a href="https://www.gob.mx/cms/uploads/attachment/file/275444/Final_Report.pdf" class="text-uppercase primary-btn2 primary-border circle" target="_blank">Ver detalles</a>
						</div>																		
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-40 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Evidencia de preparacion biodiesel.</h1>
								<p>Fotos sacadas de la Universidad Popular de la Chontalpa (UPCH), en ellas se muestran alumnos elaborando biodiesel a partir del materiales ya mencionados.
								</p>
							</div>
						</div>
					</div>						
						...
						<div class="active-works-carousel mt-40">
							<div class="item">
								...
								<div class="caption text-center mt-20">
									<h6 class="text-uppercase">Anotacion 1</h6>
							...
							<div class="item">
								<img class="img-fluid" src="img/project.jpg" alt="">
								<div class="caption text-center mt-20">
									<h6 class="text-uppercase">Anotacion 2</h6>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have <br> allowed humanity to create slimmer, more portable technology.</p>
								</div>
							</div>
							<div class="item">
								<img class="img-fluid" src="img/project.jpg" alt="">
								<div class="caption text-center mt-20">
									<h6 class="text-uppercase">Anotacion 3</h6>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have <br> allowed humanity to create slimmer, more portable technology.</p>
								</div>
							</div>
							<div class="item">
								<img class="img-fluid" src="img/project.jpg" alt="">
								<div class="caption text-center mt-20">
									<h6 class="text-uppercase">Anotacion 4</h6>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have <br> allowed humanity to create slimmer, more portable technology.</p>
								</div>
							</div>
							<div class="item">
								<img class="img-fluid" src="img/project.jpg" alt="">
								<div class="caption text-center mt-20">
									<h6 class="text-uppercase">Anotacion 5</h6>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have <br> allowed humanity to create slimmer, more portable technology.</p>
								</div>
							</div>
						</div>

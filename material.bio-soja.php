<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Biodiesel a base de Soja</title>
		...
		<body>
					...
					<div class="container">
						  ...
						  <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
						    <ul class="navbar-nav">
								...
								<li><a href="aceite-enzimas-biodiesel.php">Regresar</a></li>
							   <!-- Dropdown 
							    <li class="dropdown">
			...
			<section class="generic-banner relative" id="home">		
				...
				<div align="center">
					<img src="tablas/tabla1.png" alt="" width="600" 
                        height="460">
...
<ul class="list-group"  >
  <li class="list-group-item list-group-item-success">200 ml de aceite de soja</li>
  <li class="list-group-item list-group-item-secondary">61.7 ml de etanol anhidro</li>
  <li class="list-group-item list-group-item-info">2.1 g de NaOH (Hidróxido de sodio)</li>
  <li class="list-group-item list-group-item-warning">3.2 ml de H2SO4 (Ácido sulfúrico)</li>
  <li class="list-group-item list-group-item-danger">1.3 ml de C2H4O2 (Ácido acético o vinagre)</li>
					...
					<div class="row justify-content-center d-flex align-items-center">
						<div class="col-md-3 single-team">
						    <div class="thumb">
						        <img class="img-fluid" src="tablas/1" alt="">
						...
						<div class="col-md-3 single-team">
						    <div class="thumb">
						        <img class="img-fluid" src="tablas/2" alt="">
						        <div class="align-items-center justify-content-center d-flex">
						...
						<div class="col-md-3 single-team">
						    <div class="thumb">
						        <img class="img-fluid" src="tablas/3.jpeg" alt="">
						        <div class="align-items-center justify-content-center d-flex">
						...
						<div class="col-md-3 single-team">
						    <div class="thumb">
						        <img class="img-fluid" src="tablas/4" alt="">
						        <div class="align-items-center justify-content-center d-flex">
...
<br>7.	Se repetirá el montado de equipo, pero esta vez tendrá 200 ml de la fase esterificada que se obtiene del paso anterior, esta fase tiene un color ámbar que es fácil de identificar, y se llevara a calentamiento a las mismas condiciones de la primera parte del proceso.
</p>
						</div>
						<div class="col-lg-12">
							<div class="img-text">
								<img src="tablas/bio3.jpeg" alt="" class="img-fluid float-left mr-20 mb-20">
							<p>8.	Una vez que el líquido alcanzo la temperatura establecida se le añade el mezclado de alcohol-catalizador y se lleva a agitación a 200 RPM durante 60 minutos.
...
<br>11.	Después de realizar la separación de las fases, el biodiesel debe lavarse para purificarse y alcanzar la mayor concentración de etil ésteres. El lavado tiene la función de eliminar trazas de glicerol, catalizador, alcohol, jabones o gomas que pueden no haber reaccionado, este proceso se debe efectuar hasta lograr neutralizar. Un lavado se realiza con agua a 40 °C, el volumen que se emplea de agua es la tercera parte del volumen de biodiesel obtenido. El volumen de agua empleado se dividió efectuando tres lavados. Un aspecto importante es que la vertida del agua en el biodiesel debe ser lento para que puede tener un contacto homogéneo con todo el biocombustible y así pueda arrastrar al fondo del balón las trazas de las impurezas, posteriormente se dejara separar las fases por lo cual no se puede establecer un tiempo; este proceso se repite tres veces.
<br>12.	El otro lavado efectuado a algunos de los ensayos fue con ácido acético, el volumen del agente de lavado se utilizó en dos lavados y posteriormente se efectuó un tercer lavado con agua des ionizada. En cada lavado se debe dejar un tiempo aproximado de 12 h, para dejar separar las fases y después se extrae el agente de lavado, obteniendo así el biodiesel. 
						...
						<div class="col-md-10">
							<div class="img-text">
								<img src="tablas/soja.jpeg"  width="500" 
                        height="400"alt="" class="img-fluid float-left mr-20 mb-20"> <h1>Analisis de resultado</h1>
								<p>El biodiesel obtenido o producido debe ser un líquido a temperatura ambiente sin ningún contenido de solidos o geles, tiene una variación de colores entre el dorado y marrón oscuro. Para obtener el porcentaje del rendimiento de los ensayos realizados en el laboratorio, se estableció mediante la relación entre el peso del biodiesel y el peso del aceite de soja. En conclusión, se logra establecer que el biodiesel con mejor rendimiento (88,9%) obtenido en el laboratorio a partir de aceite usado de soja y etanol, utilizando catalizadores ácidos. 

Cada cultivo tiene diferentes capacidades de producción de aceite con sus ventajas y
límites. Para el aceite de soja se tiene 183 ton de capacidad de biodiesel del cultivo de soja.
</p>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="sigle-service col-lg-3 col-md-6">
							...
							<a href="material.bio-soja.php" class="text-uppercase primary-btn2 primary-border circle">Ver detalles</a>
						</div>
						<div class="sigle-service col-lg-3 col-md-6">
							...
							<a href="#methodd" class="text-uppercase primary-btn2 primary-border circle">Ver detalles</a>
						</div>
						<div class="sigle-service col-lg-3 col-md-6">
